const messages = {
  "zh-CN": {
    heroText: "使用你自己的 GitHub Token 生成贡献者头像墙快照。Token 只用于本次生成，不会保存，也不会出现在图片 URL 中。",
    languageLabel: "Language",
    createToken: "创建 GitHub Token",
    githubToken: "GitHub Token",
    tokenHint: "推荐 Fine-grained Token，只给目标仓库 Metadata: Read-only 权限。Token 只通过 HTTPS POST 发送一次。",
    repo: "Repository",
    title: "标题",
    description: "描述",
    ...
    anon: "包含匿名贡献者",
    generate: "生成快照 URL",
    ttlHint: "TTL 为 0 表示不过期，但公共服务不建议开放永久快照，否则 KV 容量容易被滥用。",
    preview: "预览",
    imageUrl: "图片 URL",
    markdown: "Markdown",
    html: "HTML",
  ...
  en: {
    heroText: "Generate a contributor wall snapshot with your own GitHub Token. The token is used once, never saved, and never included in the image URL.",
    languageLabel: "Language",
    createToken: "Create GitHub Token",
    githubToken: "GitHub Token",
    tokenHint: "A fine-grained token with Metadata: Read-only access for the target repository is recommended. The token is sent once over HTTPS POST.",
    repo: "Repository",
    title: "Title",
    ...
    generate: "Generate snapshot URL",
    ttlHint: "TTL 0 means no expiration, but public services should avoid unlimited snapshots to keep KV usage controlled.",
    preview: "Preview",
    imageUrl: "Image URL",
    markdown: "Markdown",
    html: "HTML",
